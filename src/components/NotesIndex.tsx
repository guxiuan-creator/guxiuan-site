  ...
  return (
    <section className="space-y-6">
      <div className="space-y-3">
        ...
        <p className="text-xs text-zinc-500">{filtered.length} / {notes.length}</p>
      </div>
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        {filtered.map((item) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group overflow-hidden rounded-3xl border border-zinc-950/10 bg-white transition hover:border-zinc-950/20 hover:bg-zinc-50"
          >
            ...
            <div className="space-y-2 p-5">
              ...
              <p className="text-sm text-zinc-600">跳转阅读 →</p>
            </div>
          </a>
        ))}
      </div>
